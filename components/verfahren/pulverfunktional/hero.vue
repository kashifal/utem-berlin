<template>
  <div class="hero w-full bg-cover bg-center"  style="background-image: url('https://ucarecdn.com/a2fbde33-ce81-4d3a-b014-09d1a8998a08/-/quality/smart/-/resize/1800x/');">
    <div class="inner">
      <h5 class="font-InterExtraBold text-white text-5xl">
        PULVERBESCHICHTUNG FUNCTIONAL<br>
        <span class="text-amber-400">BESONDERE EFFEKTE</span>
      </h5>
    </div>
