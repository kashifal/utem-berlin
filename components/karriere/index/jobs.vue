<template>
  <!-- blog posts section -->
    <section class="relative mt-24 w-full px-10 md:px-[40px] xl:px-[280px]">
      <h1 class="scrollanime absolute left-1 -top-16 md:left-4  xl:left-20 md:-top-36 text-6xl sm:text-[120px] lg:text-[186px] text-amber-100 font-bold">
        Job offer
      </h1>
      <div class="pt-24">
        <div class="space-y-4">
          ...
          <h3 class="text-3xl font-semibold">
            Mitarbeiter:in im Team Qualitätssicherung (m/w/d)
          </h3>
