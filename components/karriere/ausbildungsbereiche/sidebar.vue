<template>
    ...
    <section class="w-full p-3 hidden lg:inline">
        <div class="flex items-center space-x-2">
            <div class="leading-4">
                <div class="text-left pl-0">
                    <span class="font-bold text">Karriere page test </span>
        ...
        <h4 class="text font-bold my-5">Navigation auto</h4>
        <p id="start-nav-link" @click="scrolTo('#hero')" class="nav-link text-[12px] cursor-pointer">
            Start
        </p>
        <p id="projektbeschreibung-nav-link" @click="scrolTo('#projektbeschreibung')"
        ...
        <div class="flex justify-between mt-3">
            <div>
                <p id="decklackprodukt-nav-link" @click="scrolTo('#decklackprodukt')"
                    class="nav-link text-[12px] cursor-pointer">
                    Decklackprodukt
                </p>
                <p id="decklackproduktgeneral-nav-link" @click="scrolTo('#decklackproduktgeneral')"
                    class="nav-link text-[12px] cursor-pointer">
                    allgemeine Info
                </p>
                <p id="decklackproduktproduktion-nav-link" @click="scrolTo('#decklackproduktproduktion')"
                    class="nav-link text-[12px] cursor-pointer">
                    Decklack Produktion
                </p>
            </div>
        ...
        <div class="flex space-x-4 items-center mt-2 fill-gray-600">
            <img class="w-20 object-cover object-center mt-3" src="/img/karriere/sidebar_sauer_01.jpg"
                alt="" />
            <div>
                <p class="text-[12px] font-semibold mt-3 leading-tight">
                    Stephanie Sauer<br>
                    Personalmanagement (B.A.)<br>
                </p>
