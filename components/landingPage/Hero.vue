...
<template >
  <div class="bg-[#FA4529]">
    ...
    <div class="max-w-screen-xl mx-auto pt-[12%] pb-24 px-3" ref="main">
      ...
      <section class="mt-16 lg:mt-32 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 setOpacity box">
        <div v-for="(_, index) in Array(3)" :key="index" class="w-full h-[36rem] relative overflow-hidden group box">
