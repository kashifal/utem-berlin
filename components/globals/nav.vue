    ...
    <div class="nav-menu z-50 flex justify-start items-center px-10 md:px-[40px] xl:px-[130px]">
      ...
      <nuxt-link to="/" class="logo cursor-pointer w-20 lg:w-64">
        <svg
          ...
          x="0px"
          y="0px"
          viewBox="0 0 305.15 69.37"
          style="enable-background:new 0 0 305.15 69.37;"
          xml:space="preserve"
        >
          <g>
            <path
              d="M41.86,0v53.96h-12.8v-3.55c-2.47,2.93-6.01,4.62-10.95,4.62C7.78,55.04,0,46.25,0,34.69c0-11.56,7.78-20.35,18.11-20.35
            ...
            />
            <path
              d="M73.39,53.96l-6.71-9.48l-6.71,9.48H45.56L59.51,34.3L46.1,15.42h14.41l6.17,8.71l6.17-8.71h14.49L73.93,34.3l13.95,19.66
                        H73.39z"
            />
            <path
              d="M133.44,34.69c0,11.56-7.78,20.35-18.11,20.35c-4.93,0-8.48-1.7-10.95-4.62v18.96h-12.8V15.42h12.8v3.55
            ...
            />
            <path
              d="M176.79,36.7c0,10.22-8.01,18.02-17.88,18.02c-6.7,0-12.01-3.45-14.84-8.77v8.01h-3.45V5.63h3.45v21.82
            ...
            />
            <path
              d="M217.73,36.83c0,0.55-0.07,1.11-0.07,1.66h-31.28c0.83,7.8,6.77,12.91,14.64,12.91c5.66,0,9.94-2.62,11.94-6.28l3.04,1.8
            ...
            />
            <path
              d="M240.8,18.95v3.31c-5.94,0-11.53,3.66-11.53,12.5v19.19h-3.45V19.44h3.45v6.77C231.62,20.75,236.1,18.95,240.8,18.95z"
            />
            <path d="M247.77,3.56h3.45v50.4h-3.45V3.56z" />
            <path
              d="M260.82,8.32c0-1.45,1.24-2.69,2.76-2.69c1.52,0,2.76,1.24,2.76,2.69c0,1.52-1.24,2.76-2.76,2.76
                        C262.07,11.08,260.82,9.84,260.82,8.32z M261.86,19.44h3.45v34.52h-3.45V19.44z"
            />
            <path
              d="M305.15,32.48v21.47h-3.52V32.48c0-6.35-3.66-10.49-10.15-10.49c-6.77,0-12.08,4.42-12.08,13.74v18.23h-3.45V19.44h3.45V26
      ...
      <!-- navigation desktop-->
      <ul
        class="nav lg:flex hidden justify-start items-center uppercase xl:ml-0 font-bold leading cursor-pointer"
      >
        ...
        <li class="hoverable mr-8 xl:p-2">
          ...
          <div role="toggle" class="mega-menu1 p-6 mb-16 sm:mb-0 bg-white w-1/3">
            <div class="flex flex-wrap justify-between mx-2">
              <ul
                class="px-4 w-full sm:w-1/2 lg:w-1/2 border-gray-600 border-b sm:border-b-0 sm:border-r md:border-b-0 pb-6 pt-6 lg:pt-3"
              >
                ...
                <li>
                  <nuxt-link
                    to="/unternehmen"
                    class="block p-1 hover:bg-teal-900 text-sm text-gray-600 hover:text-white"
                  >Profil</nuxt-link>
                </li>
                <li>
                  <nuxt-link
                    to="/innovationen"
                    class="block p-1 hover:bg-teal-900 text-sm text-gray-600 hover:text-white"
                  >Innovationen</nuxt-link>
                </li>
                <li>
                  <nuxt-link
                    to="/zertifizierung"
                    class="block p-1 hover:bg-teal-900 text-sm text-gray-600 hover:text-white"
                  >Zertifizierungen</nuxt-link>
                </li>
              </ul>
        ...
        <li class="hoverable mr-8 xl:p-2">
          ...
          <div role="toggle" class="mega-menu p-6 mb-16 sm:mb-0 bg-white w-full">
            <div class="flex flex-wrap justify-between mx-2">
              ...
              >
                <h3
                  class="font-bold text-sm text-gray-600 text-bold"
                >Sektoren - Unsere Geschäftsbereiche</h3>
                <li>
                  <nuxt-link
                    to="/decorative"
                    class="block p-1 hover:bg-teal-900 text-sm text-gray-600 hover:text-white"
                  >Decorative</nuxt-link>
                </li>
                <li>
                  <nuxt-link
                    to="/functional"
                    class="block p-1 hover:bg-teal-900 text-sm text-gray-600 hover:text-white"
                  >Functional</nuxt-link>
                </li>
                <li>
                  <nuxt-link
                    to="/mobility"
              ...
              <ul
                class="px-4 sm:w-1/2 lg:w-1/4 border-gray-600 border-b sm:border-r lg:border-b-0 pb-6 pt-6 lg:pt-3"
              >
                <h3 class="font-bold text-sm text-gray-600 text-bold mb-2">Verfahren</h3>
                <li>
                  <nuxt-link
                    to="/gleitlackbeschichtung"
                    class="block p-1 hover:bg-teal-900 text-sm text-gray-600 hover:text-white"
                  >Gleitlackbeschichtung</nuxt-link>
                </li>
                <li>
                  <nuxt-link
                    to="/korrosionsschutz"
                    class="block p-1 hover:bg-teal-900 text-sm text-gray-600 hover:text-white"
                  >Korrosionsschutz</nuxt-link>
                </li>
                <li>
                  <nuxt-link
                    to="/pulverbeschichtung-dekorativ"
                    class="block p-1 hover:bg-teal-900 text-sm text-gray-600 hover:text-white"
                  >Pulverbeschichtung dekorativ</nuxt-link>
                </li>
                <li>
                  <nuxt-link
                    to="/pulverbeschichtung-funktional"
                    class="block p-1 hover:bg-teal-900 text-sm text-gray-600 hover:text-white"
                  >Pulverbeschichtung funktional</nuxt-link>
                </li>
                <li>
                  <nuxt-link
                    to="/pulverbeschichtung-architektur"
                    class="block p-1 hover:bg-teal-900 text-sm text-gray-600 hover:text-white"
                  >Pulverbeschichtung architektur</nuxt-link>
                </li>
                <li>
                  <nuxt-link
                    to="/nasslackbeschichtung"
                    class="block p-1 hover:bg-teal-900 text-sm text-gray-600 hover:text-white"
                  >Nasslackbeschichtung</nuxt-link>
                </li>
                <li>
                  <nuxt-link
                    to="/ktl-beschichtung"
                    class="block p-1 hover:bg-teal-900 text-sm text-gray-600 hover:text-white"
                  >KTL-Beschichtung</nuxt-link>
                </li>
              </ul>
              <ul
              ...
              >
                ...
                <li>
                  <nuxt-link
                    to="/maschinenbau"
                    class="block p-1 hover:bg-teal-900 text-sm text-gray-600 hover:text-white"
                  >Maschinenbau</nuxt-link>
                </li>
                <li>
                  <nuxt-link
                    to="gebrauchswaren"
                    class="block p-1 hover:bg-teal-900 text-sm text-gray-600 hover:text-white"
                  >Gebrauchswaren</nuxt-link>
                </li>
                <li>
                  <nuxt-link
                    to="/armaturen"
              ...
              >
                ...
                <li>
                  <nuxt-link
                    to="/1/uceva"
                    class="block p-1 hover:bg-teal-900 text-sm text-gray-600 hover:text-white"
                  >customOnePager DE</nuxt-link>
                </li>
                <li>
                  <nuxt-link
                    to="/1/anewe"
                    class="block p-1 hover:bg-teal-900 text-sm text-gray-600 hover:text-white"
                  >customOnePager FU</nuxt-link>
                </li>
                <li>
                  <nuxt-link
                    to="/1/cahif"
                    class="block p-1 hover:bg-teal-900 text-sm text-gray-600 hover:text-white"
                  >customOnePager MO</nuxt-link>
                </li>
                <li>
                  <nuxt-link
                    to="/1/honir"
                    class="block p-1 hover:bg-teal-900 text-sm text-gray-600 hover:text-white"
                  >customOnePager AR</nuxt-link>
                </li>
              </ul>
            </div>
          </div>
        ...
        <li class="mr-8 xl:p-2">
          <nuxt-link to="/portfolio" class="focus:outline-none hover:text-white">Portfolio</nuxt-link>
        </li>
        <li class="mr-8 xl:p-2">
          <nuxt-link
            to="/kontakt"
            class="focus:outline-none hover:text-white"
          >{{ $t("globalNav.kontakt") }}</nuxt-link>
        </li>
        <li class="lang xl:mr-8 xl:p-2">
          <button
            class="font-bold leading text-sm focus:outline-none hover:text-gray-300"
            :class="{ 'text-black': $i18n.locale == 'de' }"
            @click="$i18n.locale = 'de'"
          >de</button>
          <span>/</span>
          <button
            class="font-bold leading text-sm focus:outline-none hover:text-gray-300"
            :class="{ 'text-yellow-400': $i18n.locale == 'en' }"
            @click="$i18n.locale = 'en'"
          >en</button>
        </li>
      </ul>
      <div
        @click="$emit('show-coatingai-modal')"
        class="coatingai-but w-40 lowercase pl-4 large:ml-8"
      >
