<template>
  <div ref="coatingaiModalRef"
    ...
    <img class="absolute w-full h-full z-0 top-0 left-0" src="/img/menu_background.png" />

    <div class="w-full z-20">
      <!-- close button -->
      <div @click="$emit('hide-coatingai-modal')"
        class="absolute  top-16 right-16 stroke-white hover:stroke-amber-500 stroke-[1] cursor-pointer origin-center hover:rotate-90 transition ease-in-out">
          ...
          <div class="relative w-full h-full pb-24 text-left text-sm text-white leading-4 ">
            ...
            <div v-if="selectedSteps" class="flex h-48 xl:space-x-16 pt-6">
              <div v-for="i in 6" :key="i" class="w-40" :style="{ opacity: selectedSteps['step' + i].opacity ? selectedSteps['step' + i].opacity : 1 }">
                ...
                <div class="w-40 h-[90px] border-dashed border border-white-500">
              ...
              <div class="flex">
                <div class="grid grid-cols-3 gap-8 pt-6">
                  ...
                  <div @click="selectItem('c1', '2'); updateStep(steps.pulver_decorative)"
                    :class="{ 'ring-4 ring-green-500 ring-offset-4 ring-offset-black': selectedGroupItem['c1'] == '2' }"
                    class="">
                    <div class="relative">
                  ...
                  <div @click="selectItem('c1', '3'); updateStep(steps.pulver_functional)"
                    :class="{ 'ring-4 ring-green-500 ring-offset-4 ring-offset-black': selectedGroupItem['c1'] == '3' }"
                    class="">
                    <div class="relative">
                  ...
                  <div @click="selectItem('c1', '4'); updateStep(steps.pulver_architecture)"
                    :class="{ 'ring-4 ring-green-500 ring-offset-4 ring-offset-black': selectedGroupItem['c1'] == '4' }"
                    class="">
                    <div class="relative">
                      <img class="object-fill" src="/img/coatingai/gleitlack1_01.png">
                      <div class="absolute top-4 left-6 text-gray-700 text-2xl leading-6">
                  ...
                  <div @click="selectItem('c1', '5'); updateStep(steps.ceramheo)"
                    :class="{ 'ring-4 ring-green-500 ring-offset-4 ring-offset-black': selectedGroupItem['c1'] == '5' }"
                    class="">
                    <div class="relative">
                      <img class="object-fill" src="/img/coatingai/pulver-dekorative1_01.png">
                  ...
                  <div @click="selectItem('c1', '6'); updateStep(steps.ecoatheo)"
                    :class="{ 'ring-4 ring-green-500 ring-offset-4 ring-offset-black': selectedGroupItem['c1'] == '6' }"
                    class="">
                    <div class="relative">
                      <img class="object-fill" src="/img/coatingai/pulver-functional1_01.png">
                      <div class="absolute top-4 left-6 text-gray-700 text-2xl leading-6">
