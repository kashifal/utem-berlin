<template>
  <section class="font-sans flex flex-col lg:flex-row h-[50vH]">
    <div class="w-full lg:w-full flex flex-col text-left p-8 px-[160px]">
      <h1 class="my-4 font-bold text-3xl">INTRO eMOBILITY</h1>
      <p class="leading-normal mb-4 text-gray-700 pr-[300px]">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
